jQuery(document).ready(function($) {
    ...
    function loadInvestmentConfiguration() {
        const nonce = jawnecenyResourceModalData.investment_nonce;

        return $.post(jawnecenyResourceModalData.ajaxurl, {
    ...
    function loadResourceData(resourceId) {
        const nonce = jawnecenyResourceModalData.nonce;


        $.post(jawnecenyResourceModalData.ajaxurl, {
            ...
            if (response.success) {
                ...
                // Use window.jawnecenyResourceModalData.defaultStatus passed from PHP
                $('#modal-status').val(data.status || window.jawnecenyResourceModalData.defaultStatus);
    ...
    $('#resource-modal-form').on('submit', function(e) {
        ...
        formData.append('nonce', jawnecenyResourceModalData.nonce);
        ...
        $.ajax({
            url: jawnecenyResourceModalData.ajaxurl,
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    function applyPropertyTypeLogic(propertyType) {
        ...
        // Use window.jawnecenyResourceModalData.propertyTypes passed from PHP
        const propertyTypes = window.jawnecenyResourceModalData.propertyTypes;
