...
class ResourceModal extends JawneCeny_AdminPage {
    ...
    public function enqueue_assets() {
        ...
        wp_localize_script('resource-modal', 'jawnecenyResourceModalData', [
    ...
    private function handle_pdf_upload(): ?string {
        ...
        // Ensure ujc-data directory exists
    ...
    /**
     * Filter callback to customize upload directory to ujc-data
     * Used during wp_handle_upload() for floor plan PDFs
     *
     * @param array $dirs WordPress upload directory configuration
     * @return array Modified upload directory configuration
     */
    public function custom_upload_dir($dirs): array {
        return $this->fileManager->getUploadDirConfig();
    }
